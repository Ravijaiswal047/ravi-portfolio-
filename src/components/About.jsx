      ...
      <div className="container">
        ...
        <div className="about-content">
          <div className="about-text">
            ...
            <p>
              My journey in software development has led me to work with modern frameworks and technologies, 
              always staying updated with the latest industry trends. I believe in writing clean, maintainable 
